        ...
        <div class="row clearfix">
            <div class="col-md-12 column">
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                    <!--requestScope从服务器传递结果到页面，在页面中取出服务器端保存的值！-->
...
<%--                                restful: ${pageContext.request.contextPath}/book/toUpdateBook/${book.getBookID()}"--%>
                                <a href="${pageContext.request.contextPath}/book/toUpdateBook/${book.getBookID()}">更改</a> &nbsp|&nbsp
